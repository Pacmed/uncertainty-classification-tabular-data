...
def logit(predictions: Union[np.ndarray, list]) -> np.ndarray:
...
def platt_scale(test_predictions: Union[np.ndarray, list],
                val_predictions: Union[np.ndarray, list],
                y_val: Union[np.ndarray, list]) -> np.ndarray:
    """ Scale the predictions with Platt scaling, based on the validation data. Return the
    scaled predictions.

    Parameters
    ----------
    test_predictions: Union[np.ndarray, list]
